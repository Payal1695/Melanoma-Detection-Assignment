...
1. **Model Training Progress**:
   ...
   - Training accuracy improved with each epoch, reaching approximately 80.60% by the end.

2. **Validation Performance**:
   - The validation accuracy improved consistently with each epoch, peaking at around 77.06%.
